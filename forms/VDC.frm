VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} VDC 
   Caption         =   "Chuan Hoa nhom toan VD VDC"
   ClientHeight    =   1455
   ClientLeft      =   105
   ClientTop       =   450
   ClientWidth     =   7815
   OleObjectBlob   =   "VDC.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "VDC"
...
Application.ScreenUpdating = True
    msg = "V" & ChrW(259) & "n b" & ChrW(7843) & "n c" & ChrW(7911) & "a b" & ChrW(7841) & "n c" & ChrW(417) & " b" & ChrW(7843) & "n " & ChrW(273) & "" & ChrW(227) & " " & ChrW(273) & "" & ChrW(432) & "" & ChrW(7907) & "c " & ChrW(273) & "" & ChrW(7883) & "nh d" & ChrW(7841) & "ng theo chu" & ChrW(7849) & "n " & ChrW(273) & "" & ChrW(7883) & "nh d" & ChrW(7841) & "ng c" & ChrW(7911) & "a VDC"
...
Private Sub DapanVDC()
    ...
    End With
    Call Dapan
Dim VDCFindText As String
Selection.HomeKey wdStory
VDCFindText = "Ch" & ChrW(7885) & "n A"
Selection.Find.Execute VDCFindText
