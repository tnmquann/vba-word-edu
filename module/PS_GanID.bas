Attribute VB_Name = "PS_GanID"
Option Explicit
Public Sub Gan_ID(ByVal control As Office.IRibbonControl)
    GanID.Show
End Sub

Function prepare_list(ByVal table_index As Integer, ByVal cot As Long, ByVal cot1 As String, ByVal cot2 As String)
